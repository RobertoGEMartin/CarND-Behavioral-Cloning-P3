...
if pretrained_model:
    ...
    model.load_weights('./cp/model-p3-v08_2.h5')



from keras.callbacks import ModelCheckpoint, EarlyStopping, TensorBoard
checkpointer = ModelCheckpoint(filepath="./cp/model-p3-v08_2.h5", verbose=1, save_best_only=True,
...
tensorboard = TensorBoard(log_dir='./logs/model-08', histogram_freq=0, write_graph=True, write_images=True)
